...
_STRINGS: dict = {
    ...
    "play_select": {
        ...
        "back":         {"en": "< BACK",         "ru": "< НАЗАД",    "ro": "< ÎNAPOI"},
        "transfer_mode":{"en": "TRANSFER", "ru": "ПЕРЕВОДНОЙ", "ro": "TRANSFER"},
        "transfer_sub": {"en": "Same rank redirects the attack", "ru": "Тот же ранг — перевод атаки", "ro": "Același rang redirecționează"},
    },
    ...
    "game": {
        ...
        "status_taking":    {"en": "TAKING CARDS","ru": "БЕРЁТ КАРТЫ","ro": "IAU CĂRȚILE"},
        ...
        "let_take":         {"en": "LET TAKE",   "ru": "ПУСТЬ БЕРЁТ","ro": "LASĂ SĂ IA"},
        "transfer":         {"en": "TRANSFER",   "ru": "ПЕРЕВОД",    "ro": "TRANSFER"},
        "too_many_cards":   {"en": "table full", "ru": "стол полон", "ro": "masă plină"},
