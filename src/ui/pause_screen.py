...
class PauseScreen:
    ...
    def __init__(self, fonts: dict) -> None:
        ...
        self._achievements_btn = Button(cx, btn_y0 + (BTN_H + BTN_GAP),     "ACHIEVEMENTS",
                                        w=bw, h=BTN_H, font=fonts["btn"])
        self._settings_btn     = Button(cx, btn_y0 + (BTN_H + BTN_GAP) * 2, "SETTINGS",
                                        w=bw, h=BTN_H, font=fonts["btn"])
        self._menu_btn         = Button(cx, btn_y0 + (BTN_H + BTN_GAP) * 3, "MAIN MENU",
                                        w=bw, h=BTN_H, font=fonts["btn"])
